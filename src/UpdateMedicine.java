...
public class UpdateMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMedicineId.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        txtMedicineId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtMedicineIdActionPerformed(evt);
            }
        });
        getContentPane().add(txtMedicineId, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 98, 381, 35));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Medicine ID:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 104, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Name:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(286, 167, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, -1, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(342, 161, 223, 35));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("Company Name:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 220, -1, -1));

        txtCompanyName.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        getContentPane().add(txtCompanyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 214, 225, 34));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("Quantity:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(267, 272, -1, -1));
        ...
        getContentPane().add(txtQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 266, 225, 35));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("Add Quantity:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 325, -1, -1));

        txtAddQuantity.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        getContentPane().add(txtAddQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(439, 319, 126, 35));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Price Per Unit [Ghc]:");
        ...
        getContentPane().add(txtPricePerUnit, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 375, 225, 35));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(363, 438, -1, 42));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       if(uniqueId.equals("")){
          JOptionPane.showMessageDialog(null, "Medicine ID field is required"); 
           ...
           JOptionPane.showMessageDialog(null, "Name ID field is required"); 
       }else if (companyName.equals("")){
           JOptionPane.showMessageDialog(null, "Company Name ID field is required"); 
         ...
         JOptionPane.showMessageDialog(null, "Price Per Unit field is invalid");   
           ...
           try{
               ...
               ps.executeUpdate();
               JOptionPane.showMessageDialog(null,"Medicine Update Successfully");
               setVisible(false);
